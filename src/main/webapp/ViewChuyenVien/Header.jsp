...
<body>
	<header>
		...
		<nav
			...
			<c:if test="${not empty UserCTSV.tenCV}">
				<div class="badge text-wrap mr-3" id="name-label">${UserCTSV.tenCV}</div>
			</c:if>


			<a href="<%=request.getContextPath()%>/logout"><button id="logoutBtn" class="btn btn-primary" type="button">Đăng
					xuất</button></a>
